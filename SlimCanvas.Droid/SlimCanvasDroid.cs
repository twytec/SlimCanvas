...
{
    public class SlimCanvasDroid : SurfaceView, ISurfaceHolderCallback, Abstractions.ISlimDraw
    {
        ...
        public SlimCanvasDroid(Context context) : base(context)
        {
            ...
            SlimCanvasPCL = new Canvas(this, new IUserInputDroid(this), new IAssetsDroid(context), new IGraphicsDroid())
            {
                Plattform = Plattform.Android
            };
            //this.Focusable = true;
        ...
        {
            ViewSizeChangedTrigger(width, height);
        }
