...
{
    internal class DrawInCanvas : ISlimDraw
    {
        DXSwapDraw swapDraw;
        bool busy = false;

        public DrawInCanvas(Windows.UI.Xaml.Controls.SwapChainPanel scp)
        {
            swapDraw = new DXSwapDraw(scp);

            scp.SizeChanged += SlimCanvasUWP_SizeChanged;
